...
public class PurchaseInvoicePaymentModel implements Serializable {
	...
	public PurchaseInvoicePaymentModel() {}
	...
	public static PurchaseInvoicePaymentModel toObject(String json) {
		ObjectMapper mapper = new ObjectMapper();
		mapper.configure(SerializationFeature.FAIL_ON_EMPTY_BEANS, false);
		try {
			return mapper.readValue(json, PurchaseInvoicePaymentModel.class);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return null;
